...
async function verificarCodigo() {
  ...
  try {
    ...
    // El backend valida el código al actualizar la contraseña, pero podemos verificar primero
    // Si el backend tiene un endpoint específico para validar, usarlo aquí
    // Por ahora, redirigimos a la página de nueva contraseña donde se validará el código
    // Si necesitas validar antes, puedes crear un endpoint POST /apprentices/verifyResetCode
    // Por simplicidad, asumimos que la validación ocurre al cambiar la contraseña
